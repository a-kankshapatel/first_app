...
import 'package:first_app/ui_demo/test_ui.dart';
import 'package:flutter/material.dart';

class BakeryApp extends StatefulWidget {
  const BakeryApp({Key? key, BakeryApp child}) : super(key: key);
              ...
              GridView.count(
                ...
                children: [
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/img1.jpg', 100, 200, 1),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/img2.jpg', 100, 200, 2),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/img4.jpg', 100, 200, 3),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/img5.jpg', 100, 200, 4),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/img6.jpg', 100, 200, 5),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/img7.jpg', 100, 200, 6),
                ],
              )
            ],
          )
